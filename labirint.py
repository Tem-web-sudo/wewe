...
packman = Player('face.png', 5, win_height - 80, 80, 80, 0, 0)
final_sprite = GameSprite('briefcase.png', win_width - 85, win_height - 100, 80, 80)

monster1 = Enemy('thief.png', win_width - 80, 150, 80, 80, 5)
monster2 = Enemy('thief.png', win_width - 80, 150, 80, 80, 5)
